                        ...
                        <div class="wrapper-page">
                            ...
                            <div class="m-t-40 account-pages">
                                ...
                                <div class="text-center m-b-20">
                                        <div class="m-b-20">
                                            <h1 style="font-size:70px; color: red;">404</h1>
                                        </div>
                                        <p class="text-muted font-13 m-t-10">
                                           The voting system that you have been requesting is <strong>not found.</strong> Please contact the administrator for assistance.
                                        </p>
                                        <br>
