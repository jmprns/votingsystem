...
<html class="account-pages-bg">
    <head>
        ...
        <!-- App title -->
        <title>Voting System - Server Error</title>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        ...
                        <div class="wrapper-page">
                            <img src="{{ asset('media/animat-diamond-color.gif') }}" alt="" height="120">
                            <h2 class="text-uppercase text-danger">Internal Server Error</h2>
                            ...
                            <a class="btn btn-success waves-effect waves-light m-t-20" href="/admin/dashboard"> Return Home</a>
                        </div>
